...
<head>
    ...
    <title>VISIONSTACK - Web Development, Custom Software & SaaS Solutions</title>
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row gy-5">
                ...
                <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="400">
                    <div class="service-item">
                        <div class="img">
                            <img src="assets/img/austin-distel-mpN7xjKQ_Ns-unsplash.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="details position-relative">
                            <div class="icon">
            ...
            <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="tab-pane fade" id="features-tab-4">
                    <div class="row">
                        ...
                        <div class="col-lg-6 order-1 order-lg-2 text-center">
                            <img src="assets/img/nubelson-fernandes-iqxAMCdfKz0-unsplash.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                </div><!-- End Tab Content Item -->
